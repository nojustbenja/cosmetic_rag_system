      ...
      <div className="px-4 py-4 pr-10">
        ...
        {(prodCount > 0 || profile) && (
          <div className="flex flex-wrap items-center gap-1.5 mt-2.5">
            ...
            {profile && (
              <span className="inline-flex items-center rounded-full bg-primary/10 border border-primary/20 px-2 py-0.5 text-[10px] font-bold text-primary capitalize max-w-[150px] truncate">
                {profile}
              </span>
            )}
          </div>
